...
➻ AmangRobot adalah bot manager + music untuk mengelola grup anda dengan baik.
➻ Tekan /help Untuk Bantuam.
➻ Maintaned By @amwang.
...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="ᴅᴏɴᴀsɪ", url=f"https://t.me/amwangstore/52"),
    ],
    [
...
*ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ :* [ɢɪᴛʜᴜʙ](https://github.com/amanqs/AmgRobot)


{BOT_NAME} ɪs ʟɪᴄᴇɴsᴇᴅ ᴜɴᴅᴇʀ ᴛʜᴇ [ᴍɪᴛ ʟɪᴄᴇɴsᴇ](https://github.com/amanqs/AmgRobot/blob/master/LICENSE).
© 2022 - 2023 [@ᴀᴍᴀɴɢ](https://t.me/{SUPPORT_CHAT}), ᴀʟʟ ʀɪɢʜᴛs ʀᴇsᴇʀᴠᴇᴅ.
""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
